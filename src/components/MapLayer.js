      ...
      for (
        ...
        if (props.cells[x]) {
          for (
            ...
            if (props.cells[x][y] && props.cells[x][y].texture) {
              if (!(previousCells.current[x] && previousCells.current[x][y]) || props.cells[x][y] !== previousCells.current[x][y]) {
                ctx.drawImage(props.cells[x][y].texture.image, x * props.cellSize, y * props.cellSize);
              }
            }
            else {
